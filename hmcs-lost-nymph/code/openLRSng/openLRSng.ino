...
//
// This copy of the code is heavily modified for the HMCS Lost Nymph
// For the RX, it compiles for Teensy LC and controls motors directly via H-bridge circuitry
// For the TX, it is mostly unchanged, to be used for the OrangeRX module
//
...
#define BOARD_TYPE 10 // HMCS Lost Nymph
