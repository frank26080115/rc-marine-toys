...
// RX operation
#if 0
#define PPM_OUT  9  // HMCS Lost Nymph: not used
#define RSSI_OUT 3  // HMCS Lost Nymph: not used
#endif

// #define ANTENNA_DIVERSITY // don't think we have this on HMCS Lost Nymph
